...
from routers.v1.rss_router import router as rss_router
...
app = FastAPI(
    title="Torrents-Api",
    version="1.0.2",
    description="Unofficial Torrents / Books / Courses API — 26 sites, mirror rotation, combo search",
    docs_url="/docs",
    contact={
        "name": "Ajay",
...
app.include_router(rss_router, prefix="/api/v1/rss", dependencies=[Depends(authenticate_request)])
