...
from routers.v1.torznab_router import router as torznab_router
...
# Torznab (Sonarr/Radarr/Prowlarr/Jackett): apikey checked inside via query param
app.include_router(torznab_router, prefix="/api/v1/torznab")
