...
<p align="center">
<b>41 sites</b> — Torrents, Indian &amp; International Courses, Indian Books/Audiobooks, eBooks, Anime &amp; Audiobooks in one API.
...
- **41 sites** — general torrents + courses + Indian books/audiobooks + eBooks + anime + audiobooks + Internet Archive (books/movies/audio/software via `archive` — single fast query, every item gets a working `.torrent` link).
